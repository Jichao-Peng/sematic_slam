...
{
    string argv1 = "/home/leo/Desktop/Data/ORBvoc.txt";
    string argv2 = "/home/leo/Desktop/sematic_slam_project/src/sematic_slam/ORB_SLAM2/config/TUM1.yaml";
    string argv3 = "/home/leo/Desktop/Data/rgbd_dataset_freiburg3_teddy";
    string argv4 = "/home/leo/Desktop/Data/rgbd_dataset_freiburg3_teddy/associations.txt";
    ...
    for(int ni=0; ni<nImages; ni++)//进入循环
    {
        ...
        //等待下一帧,这个的作用就是保证图像输入的频率和实际相机输入的频率是一致的，如果系统太快完成追踪就先等一等
        double T=0;
        if(ni<nImages-1)
