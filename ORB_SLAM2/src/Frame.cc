...
namespace ORB_SLAM2
{
    ...
    Frame::Frame(const Frame &frame)
            : mpORBvocabulary(frame.mpORBvocabulary), mpORBextractorLeft(frame.mpORBextractorLeft),
              ...
              mvLevelSigma2(frame.mvLevelSigma2), mvInvLevelSigma2(frame.mvInvLevelSigma2),mvDetectResults(frame.mvDetectResults)//这里在加了mvDetectResults
    {
    ...
    void Frame::SetDetectResult(vector<DetectResult> vDetectResult)
    {
        mvDetectResults.assign(vDetectResult.begin(),vDetectResult.end());
    }
} //namespace ORB_SLAM
