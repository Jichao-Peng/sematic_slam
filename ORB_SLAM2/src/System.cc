        ...
        mbDeactivateLocalizationMode(false)
{
    ...
    // 【第六个线程】Detecting类，进行物体识别，提前开启
    cout << endl << "Loading YOLO weights. This could take a while..." << endl;
    mpDetector = new Detecting();
    mptDetecting = new thread(&Detecting::Run,mpDetector);
    cout << "Weights loaded!" << endl << endl;
